...
myWebpage.addEventListener('dblclick', function(event){
    window.location.replace('https://www.instagram.com/fellipemontes/');
});
...
//teste de eventos avulsos

myTitle.addEventListener('dblclick', function(event){
    myTitle.innerHTML = 'eu mudei o texto';
